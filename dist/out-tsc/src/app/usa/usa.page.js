...
var USAPage = /** @class */ (function () {
    function USAPage(httpnative) {
    ...
    USAPage.prototype.getnativeindexdetails = function () {
        var _this = this;
        this.httpnative.get(this.APIUrl, {}, {}).then(function (data) {
            ...
            for (var _i = 0, _a = _this.somedata; _i < _a.length; _i++) {
                var data_1 = _a[_i];
                if (JSON.stringify(data_1.indexName).indexOf("U.S.") !== -1) {
    ...
    USAPage.prototype.onProductChange = function (prod) {
    ...
    USAPage.prototype.roundValue = function (val) {
        return Math.round(val * 100) / 100;
    };
    USAPage = tslib_1.__decorate([
        Component({
            selector: 'app-usa',
...
export { USAPage };
//# sourceMappingURL=usa.page.js.map