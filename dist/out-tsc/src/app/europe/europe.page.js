...
var EuropePage = /** @class */ (function () {
    function EuropePage(httpnative) {
    ...
    EuropePage.prototype.getnativeindexdetails = function () {
        var _this = this;
        this.httpnative.get(this.APIUrl, {}, {}).then(function (data) {
            ...
            for (var _i = 0, _a = _this.somedata; _i < _a.length; _i++) {
                var data_1 = _a[_i];
                if (JSON.stringify(data_1.indexName).indexOf("UK") !== -1) {
    ...
    EuropePage.prototype.onProductChange = function (prod) {
    ...
    EuropePage.prototype.roundValue = function (val) {
        return Math.round(val * 100) / 100;
    };
    EuropePage = tslib_1.__decorate([
        Component({
            selector: 'app-europe',
...
export { EuropePage };
//# sourceMappingURL=europe.page.js.map